...
employeeRouter.post( '/employees', isAuth, checkRoles( [ 'ADMIN' ] ), validate( CreateEmployeeSchema ), ( req, res, next ) => employeeController.createEmployee( req, res, next ) );
...
employeeRouter.put( '/employees/:id', isAuth, checkRoles( [ 'ADMIN' ] ), validate( UpdateEmployeeSchema ), ( req, res, next ) => employeeController.updateEmployeeById( req, res, next ) );
