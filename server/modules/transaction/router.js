...
transactionRouter.post( '/operations/:id', isAuth, checkRoles( [ 'ADMIN', 'DOCTOR', 'PHARMACIST', 'NURSE' ] ), validate( TransactionSchema ), ( req, res, next ) => transactionController.createTransaction( req, res, next ) );
